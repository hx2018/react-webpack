...
const API_DOMAIN = "http://localhost:9000/api"; // 这是前端webpack启的web服务的域名，而后端服务器api域名是"localhost:3001"，这里用webpack启的web服务的域名是因为webpack的devServer配置了代理，9000请求会代理到3001，解决跨域问题
